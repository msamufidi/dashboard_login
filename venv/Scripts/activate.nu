...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\CODE\Python\django_learn\dashboard_login\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\CODE\Python\django_learn\dashboard_login\venv\Scripts\deactivate.nu'
